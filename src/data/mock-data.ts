...
// Image URLs are removed from initial data as they are no longer displayed in the card.
// The imageUrl field can remain in the MenuItem type if it might be used elsewhere in the future.
